...
void menugrafic()
{
 ...
 if(CONFIG_LOAD_GRAF)
 {
    cursor=GetIMGHDRFromThemeCache(0x8);
    if(fol_h>cursor->h) cursor=GetIMGHDRFromThemeCache(0x9); 
 }else
#endif
 {
 ...
 if(CONFIG_LOAD_GRAF)
 {
    ...
    temp=GetIMGHDRFromThemeCache(0);
